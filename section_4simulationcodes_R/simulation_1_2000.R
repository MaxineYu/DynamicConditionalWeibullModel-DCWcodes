#Note that here we use parameters that were estimated from real data from year 2014-2016.
simu<-matrix(nrow=500,ncol=2000)# 500 sequences of simulated data $Q_t$ with length 2000.
for(j in 1:500){
...
write.csv(mat,"simulation1_2000.csv")
